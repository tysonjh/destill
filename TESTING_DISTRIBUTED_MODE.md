# Testing Destill in Distributed Mode - Manual Test Guide

This guide walks through testing the complete distributed architecture end-to-end.
...
```bash
# From the project root directory
./bin/destill submit "https://buildkite.com/your-org/your-pipeline/builds/1234"
```
...
If all checkpoints pass, the distributed architecture is working correctly! 🎉
