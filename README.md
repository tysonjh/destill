...
3. The Ingestion Agent discovers all jobs in the build
4. Fetches and publishes log content for each job
5. The Analysis Agent processes logs and produces ranked failure cards
